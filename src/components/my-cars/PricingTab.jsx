...
export default function PricingTab({ onUpdate, car = {} }) {
  ...
  const onSubmit = (data) => {
    ...
    updateCarApi(car.id, submitData)
      .then((data) => {
    ...
    <form onSubmit={handleSubmit(onSubmit)}>
      <div className="row mb-3 align-items-center">
        <div className="col-4 col-lg-2">
          <label htmlFor="basePrice" className="form-label mb-0 fw-semibold">
            Base price:
          </label>
        </div>
        ...
        <div className="col-8 col-lg-4 d-flex align-items-center">
          <input
            ...
            {...register('requiredDeposit', {
              required: 'Required deposit is required!'
            })}
          />
      ...
      <div className="row mb-3">
        <div className="col-12 d-flex justify-content-center align-items-center">
          <button
            ...
            onClick={handleReset}
            className={clsx(
              'btn btn-link text-secondary ms-3',
              loading ? 'disabled' : ''
            )}
          >
            Discard
          ...
          <button
            type="submit"
            className={clsx('btn btn-primary px-3', loading ? 'disabled' : '')}
          >
            {loading ? 'Saving...' : 'Save'}
          </button>
        </div>
