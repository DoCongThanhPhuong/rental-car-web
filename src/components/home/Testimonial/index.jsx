          ...
          <div className="col-md-6 mt-3" data-aos="zoom-in" data-aos-delay="0">
            <div className={styles.box}>
              ...
              <div className="box-body ms-3">
                ...
                <div className="box-content fs-5.5 fst-italic">
                  "The user prefers eco-friendly vehicles for their car
                  rentals."
                </div>
              </div>
            </div>
          ...
          >
            <div className={styles.box}>
              ...
              <div className="box-body ms-3">
                ...
                <div className="box-content fs-5.5 fst-italic">
                  "The user frequently rents cars for business trips and prefers
                  premium models."
                </div>
              </div>
            </div>
          ...
          >
            <div className={styles.box}>
              ...
              <div className="box-body ms-3">
                ...
                <div className="box-content fs-5.5 fst-italic">
                  "The user has a history of renting cars for family vacations
                  and values spacious interiors."
                </div>
              </div>
            </div>
          </div>
          ...
          >
            <div className={styles.box}>
              ...
              <div className="box-body ms-3">
                ...
                <div className="box-content fs-5.5 fst-italic">
                  "The user often books last-minute rentals and values the
