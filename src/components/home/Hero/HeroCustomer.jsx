  ...
  return (
    ...
    >
      <div className="container">
        <div className="row">
          <div
            className="col-lg-5 d-flex flex-column justify-content-center py-3"
            data-aos="fade-up"
          >
            <h1 className="mb-3">
              ...
              <div className={clsx('p-4', styles.search_form)}>
                ...
                <div className="row mb-3">
                  <div className="col-12 position-relative">
                    ...
                    <input
                      ...
                      {...register('location', {
                        required: 'Please provide a pick-up location!'
                      })}
                    />
                    {errors.location && (
                      <span className="fs-7 text-white rounded px-2 position-absolute top-100 mt-1 bg-danger">
                ...
                <div className="row mb-3">
                  <div className="col-12">
                    <label htmlFor="pickUpDate" className="form-label fw-bold">
                ...
                <div className="row mb-3">
                  <div className="col-12">
                    <label htmlFor="dropOffDate" className="form-label fw-bold">
