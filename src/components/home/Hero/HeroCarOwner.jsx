      ...
      <div className="container">
          ...
          <div className="col-md-6 col-lg-4 mt-3">
            <div className={styles.box}>
              ...
              <div className="fs-6 text-justify">
                ...
                approval. If you do not feel comfortable with someone you are
                able to decline a booking.
              </div>
            </div>
          </div>
          <div className="col-md-6 col-lg-4 mt-3">
            <div className={styles.box}>
              ...
              <div className="fs-6 text-justify">
                We pay you once a month and you can always view how much your
                car has earned under your user profile.
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="row py-3 mb-4">
          <div className="col-12 d-flex justify-content-center">
            <Link to="/my-cars" className="btn btn-primary px-5 fw-semibold">
              List Your Car Today
            </Link>
          </div>
        </div>
