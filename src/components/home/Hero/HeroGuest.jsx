      ...
      <div className="container">
        <div className="row">
          <div className="col-lg-6 d-flex flex-column justify-content-center py-4 py-lg-5">
            ...
            <p className="text-center fs-5.5 text-lg-end px-lg-5">
            ...
            <div className="d-flex justify-content-center">
              <button
                ...
                className={clsx('mt-3', styles.btn_hero)}
              >
          ...
          <div className="col-lg-6 d-flex flex-column justify-content-center py-4 py-lg-5">
            ...
            <p className="text-center fs-5.5 text-lg-start px-lg-5">
              List your car and make money form your asset today!
            </p>
            <div className="d-flex justify-content-center">
              <button
                onClick={() => dispatch(setShowAuthModal(true))}
