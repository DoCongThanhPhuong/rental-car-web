...
export default function Booking() {
  ...
  useEffect(() => {
    if (missingParams.length === 0) {
      setLoading(true)
      getCarsById(searchParams.get('carId'))
        .then((data) => {
          setCar(data.data)
        })
        .finally(() => {
  ...
  const hoursDiff =
    (convertToLocalDateTime(searchParams.get('eD'), searchParams.get('eT')) -
      convertToLocalDateTime(searchParams.get('sD'), searchParams.get('sT'))) /
    (1000 * 3600)
  ...
  return (
    <>
        ...
        <div className="rent-car-booking-detail bg-rt-primary text-white">
          <div className="container py-3">
            ...
            <ul className="text-white fs-5.5 fw-semibold lh-lg">
              ...
              <li>
                Pick-up date and time: {formatDate(searchParams.get('sD'))} -{' '}
                {searchParams.get('sT')}
              </li>
              <li>
                Return date and time: {formatDate(searchParams.get('eD'))} -{' '}
                {searchParams.get('eT')}
              </li>
            </ul>
          </div>
      ...
      <div className="container">
        <StepsV2 steps={bookingSteps} currentStep={currentStep} />
      </div>
            ...
            <div className="d-flex flex-column flex-md-row">
              ...
              <div className="w-100 w-md-50 py-2 py-md-4 px-3">
                ...
                <div className="row mb-2 fw-semibold">
                  ...
                  <div className="col-8">
                    <StarRating value={car?.rating || 0} size={20} />
                  </div>
                </div>
                <div className="row mb-2 fw-semibold">
              ...
              <div className="w-100 w-md-50 py-2 py-md-4 px-3 border-md-start border-dark">
                ...
                <div className="row mb-3">
                  <h5 className="text-end">
                    Number of hours: {Math.round(hoursDiff)}h
                  </h5>
                </div>
                <div className="row mb-3">
                  <h5 className="text-end">
      ...
      {currentStep == 1 && (
        <BookingStep1 onCancel={handleCancel} onNextStep={nextStep} />
      )}
